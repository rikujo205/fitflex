...
public class UpperBodyWorkoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upper_body_workout);
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int count = prefs.getInt("upper_workout_count", 0);
                editor.putInt("upper_workout_count", count + 1);
                editor.apply();

                Intent intent = new Intent(UpperBodyWorkoutActivity.this, WorkoutSelectionActivity.class);
        ...
        if (level >= 2) {
            ...
            checkbox5.setText("4 Sets 10 Reps: Bicep Curls (LEVEL 2)");
        ...
        if (level >= 2) {
            ...
            checkbox6.setText("4 Sets 10 Reps: Shoulder Press (LEVEL 2)");
        ...
        if (level == 3) {
            ...
            checkbox7.setText("4 Sets 10 Reps: Side Lateral Pulls (LEVEL 3)");
        ...
        if (level == 3) {
            ...
            checkbox8.setText("4 Sets 10 Reps: Incline Dumbell Flye (LEVEL 3)");
