    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int count = prefs.getInt("back_workout_count", 0);
                editor.putInt("back_workout_count", count + 1);
                editor.apply();
        ...
        if (level >= 2) {
            ...
            checkbox5.setText("4 Sets 10 Reps: Barbell Rows (LEVEL 2)");
        ...
        if (level >= 2) {
            ...
            checkbox6.setText("4 Sets 10 Reps: V Bar Pull Downs (LEVEL 2)");
        ...
        if (level == 3) {
            ...
            checkbox7.setText("4 Sets 10 Reps: Seated Cable Rows (LEVEL 3)");
        ...
        if (level == 3) {
            ...
            checkbox8.setText("4 Sets 10 Reps: Pull Ups (LEVEL 3)");
